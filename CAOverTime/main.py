...
frequency = 100  # 2200  # 3200  # 2200  # 1400  # 2200  # 1400
...
root_path = 'D:/document/00Study/01接触角摩擦力/计算/液滴/stage8.2.5/NH'
square_path = '%s/ar-square-160-%.4f.profile' % (root_path, sl_types[drop_type])
y_path = '%s/ar-y-160-%.4f.profile' % (root_path, sl_types[drop_type])
